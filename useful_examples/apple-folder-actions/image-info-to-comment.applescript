...
on process_item(this_item)
	...
	try
		...
		set the comment_string to Â
			"W: " & (image_width as string) & the data_delimiter & Â
			"H: " & (image_height as string) & the data_delimiter & Â
			"R: " & (image_DPI as string) & the data_delimiter & Â
			"BD: " & bit_depth & the data_delimiter & Â
			"CS: " & color_space
		tell application "Finder"
