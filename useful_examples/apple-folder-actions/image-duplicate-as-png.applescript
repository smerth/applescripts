(*
Image - Duplicate as PNG

This Folder Action handler is triggered whenever items are added to the attached folder.
The script creates a PNG version of the file, but leaves a copy of the file
in its original format. If the original file is already in PNG format, the script does
