(*
Image - Duplicate as TIFF

This Folder Action handler is triggered whenever items are added to the attached folder.
The script creates a TIFF version of the file, but leaves a copy of the file
in its original format. If the original file is already in TIFF format, the script does
